/*
 * Public API Surface of ngx-report
 */

export { NgxReportModule } from './lib/ngx-report.module';
export { NgxReportComponent } from './lib/components/ngx-report/ngx-report.component';
export { NgxReportBaseComponent } from './lib/components/ngx-report-base/ngx-report-base.component';
